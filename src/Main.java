...
//        }
        ...
        boolean test = Data.validate("test", "test", "test");
        if (test) {
        ...
        diagnostic(car1,car2,car4,car3);
    ...
    private static void diagnostic(Transport... transports){
        for (int i = 0; i < transports.length; i++) {
            if(!transports[i].diagnostic()){
                try {
                    throw new IllegalArgumentException("Автомобиль не прошел диагностику");
